export const PERMISSIONS = {
  ...
  /** Student fees (not SaaS billing). Does not imply counselling.read. */
  FINANCE_READ: 'finance.read',
  FINANCE_MANAGE: 'finance.manage',
  FINANCE_REFUND_APPROVE: 'finance.refund.approve',
  FINANCE_CONCESSION_APPROVE: 'finance.concession.approve',
  /** Explicit; finance roles must not get this by default (rule 13). */
